...
<div class="cont span_2_of_3">
	...
	<h3 style="font-size: 26px;padding-bottom: 5px;border-bottom: 1px solid #DDD;">Add Address</h3>
	
	<?php include('well_cont/formaddress.php')?>
	
	<h3 style="font-size: 26px;padding-bottom: 5px;border-bottom: 1px solid #DDD;"></h3>
	<div class="box1">
		<?php
		// Tampilkan produk-produk yang telah dimasukkan ke keranjang belanja
			...
			if($ketemu < 1){
			echo "<script>window.alert('Your cart is empty. Fill it up!');
				window.location=('index.php')</script>";
			}
			else
			{  
		?>
<div class="body-content outer-top-xs" style="width: -1%;margin-left: -4%;margin-right: -5%;">
	<div class="container">
