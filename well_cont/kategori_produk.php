<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
	<!-- ============================================== INFO BOXES : END ============================================== -->
	<!-- ============================================== SCROLL TABS ============================================== -->
	<?php $sk=mysql_fetch_array(mysql_query("SELECT * FROM subkategori where id_subkategori ='$_GET[id]'")); ?>
	<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
		<div class="more-info-tab clearfix ">
		   <h3 class="new-product-title pull-left"><?php echo $sk['nama']; ?></h3>
		...
		<div class="tab-content outer-top-xs">
			...
			<div class="tab-pane in active" id="all">			
				<div class="product-slider">
					...
					<?php
						$produk = mysql_query("SELECT * FROM produk where tampil_depan = 'Y' AND id_subkategori = '$_GET[id]' ORDER BY id_produk DESC limit 16");
			...
			<div class="tab-pane" id="new">
				<div class="product-slider">
					<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
						<?php
							$new = mysql_query("SELECT * FROM produk where special = 'new' AND tampil_depan = 'Y' AND id_subkategori = '$_GET[id]' ORDER BY id_produk DESC limit 8");
			...
			<div class="tab-pane" id="hot">
				<div class="product-slider">
					<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
						<?php
							$hot = mysql_query("SELECT * FROM produk where special = 'hot' AND tampil_depan = 'Y' AND id_subkategori = '$_GET[id]' ORDER BY id_produk DESC limit 8");
			...
			<div class="tab-pane" id="sale">
				<div class="product-slider">
					<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
						<?php
							$promo = mysql_query("SELECT * FROM produk where special = 'promo' AND tampil_depan = 'Y' AND id_subkategori = '$_GET[id]' ORDER BY id_produk DESC limit 8");
