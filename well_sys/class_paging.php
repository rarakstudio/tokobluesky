...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " <li><span>...</span></li> <li><a href=$_SERVER[PHP_SELF]?module=$_GET[module]&halaman=$jmlhalaman>$jmlhalaman</a> </li> " : " ");
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<li><a id='page' value='1' href='javascript: processForm(1)'>First</a></li>  
                    <li><a id='page' value='$prev' href='javascript: processForm($prev)'>Prev</a> </li> ";
}
else{ 
	$link_halaman .= "<li><span>First</span></li> <li><span>Prev</span></li> ";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<li><a id='page' value='$i' href='javascript: processForm($i)'>$i</a> </li> ";
  }
	  $angka .= " <li><b>$halaman_aktif</b><li> ";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " <li><span>...</span></li> <li> <a id='page' value='$i' href='javascript: processForm($i)'>$jmlhalaman</a> </li> " : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= "<li> <a id='page' value='$next' href='javascript: processForm($next)'>Next</a> </li> 
                     <li><a id='page' value='$jmlhalaman' href='javascript: processForm($jmlhalaman)'>Last</a> </li>";
}
else{
	$link_halaman .= "<li><span>Next</span></li><li><span>Last</span></li>";
}
